# Проект по автоматизации тестирования UI для сайта компании [Максидом](https://www.maxidom.ru/)
...
Автотесты для данного проекта написаны на <code>Java</code> с использованием фреймворка <code>Selenide</code>. При проектировании тестов применён паттерн <code>PageObject</code>. Для части автотестов проекта предусловие выполняется через запросы по API с помощью <code>REST-assured</code>.
